...
const UserSchema = CollectionSchema(
  ...
  embeddedSchemas: {r'ToDoModel': ToDoModelSchema},
  getId: _userGetId,
...
int _userEstimateSize(
  ...
  {
    final offsets = allOffsets[ToDoModel]!;
    for (var i = 0; i < object.notes.length; i++) {
      final value = object.notes[i];
      bytesCount += ToDoModelSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _userSerialize(
  ...
  writer.writeObjectList<ToDoModel>(
    offsets[1],
    allOffsets,
    ToDoModelSchema.serialize,
    object.notes,
  );
  writer.writeString(offsets[2], object.password);
  writer.writeString(offsets[3], object.pathSchedules);
}
...
User _userDeserialize(
  ...
  object.id = id;
  object.notes = reader.readObjectList<ToDoModel>(
        offsets[1],
        ToDoModelSchema.deserialize,
        allOffsets,
        ToDoModel(),
      ) ??
      [];
  object.pathSchedules = reader.readStringOrNull(offsets[3]);
  return object;
}
...
P _userDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectList<ToDoModel>(
            offset,
            ToDoModelSchema.deserialize,
            allOffsets,
            ToDoModel(),
...
List<IsarLinkBase<dynamic>> _userGetLinks(User object) {
  return [object.discipline, object.student];
}
...
extension UserQueryObject on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> notesElement(
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> discipline(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> disciplineLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> disciplineIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'discipline', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> disciplineIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'discipline', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> disciplineLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> disciplineLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> disciplineLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, List<ToDoModel>, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
