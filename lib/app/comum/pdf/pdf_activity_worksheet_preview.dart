...
Future<void> pdfActivityWorkSheetPreView(
    {required BuildContext context, required Discipline discipline}) async {
  String pdfPath = '';
  Future<File> viewFile =
      PdfActivityWorkSheet().createPDF(fileName: discipline.name);
          ...
          content: SingleChildScrollView(
            ...
            children: [
              Card(
                ...
                child: Center(
                  child: FutureBuilder(
                    future: PdfActivityWorkSheet()
                        .createPDF(fileName: discipline.name),
